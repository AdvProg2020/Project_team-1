...
import old.commands.get_info_to_purchase.GetPhone;
import old.commands.get_info_to_purchase.GetPostalCode;
import old.*;
...
import static old.Filtering.filteringCommands;
import static old.LoginRegisterMenu.registerAndLoginCommands;
import static old.ManageRequestMenu.manageRequestMenuCommands;
